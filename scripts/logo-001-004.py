"""Generate logo experiment 001-004: early leveling and a horizontal final tenth."""
...
BLEND_PATH = ROOT / "blendfiles" / "logo-001-004.blend"
RENDER_PATH = ROOT / "renders" / "logo-001-004.png"
...
def main():
    ...
    # At 60% of the line, begin the deliberate leveling transition. It reaches
    # a horizontal tangent at 90%, leaving the final tenth fully horizontal.
    points = (
