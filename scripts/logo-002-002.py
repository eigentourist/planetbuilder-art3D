"""Generate logo experiment 002-002: opening lines that converge to parallel."""
...
BLEND_PATH = ROOT / "blendfiles" / "logo-002-002.blend"
RENDER_PATH = ROOT / "renders" / "logo-002-002.png"

STROKE_RADIUS = 0.105
STROKE_THICKNESS = STROKE_RADIUS * 2.0
INITIAL_EDGE_GAP = STROKE_THICKNESS * 2.0
INITIAL_CENTER_SEPARATION = STROKE_THICKNESS + INITIAL_EDGE_GAP
LOWER_DROP = STROKE_THICKNESS * 2.0
...
def main():
    ...
    make_baseline("Upper Logo Edge", upper_points, half_separation, material)
    make_baseline(
        "Lower Logo Baseline",
        BASE_POINTS,
