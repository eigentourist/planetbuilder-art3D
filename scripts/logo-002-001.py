"""Generate logo experiment 002-001: paired trajectory baselines."""
...
BLEND_PATH = ROOT / "blendfiles" / "logo-002-001.blend"
RENDER_PATH = ROOT / "renders" / "logo-002-001.png"

STROKE_RADIUS = 0.105
STROKE_THICKNESS = STROKE_RADIUS * 2.0
EDGE_GAP = STROKE_THICKNESS * 2.0
CENTER_SEPARATION = STROKE_THICKNESS + EDGE_GAP
...
def make_baseline(name, vertical_offset, material):
    ...
    # Geometry carried forward unchanged from the approved 001-004 baseline.
    points = (
...
def main():
    ...
    half_separation = CENTER_SEPARATION / 2.0
    make_baseline("Upper Baseline", half_separation, material)
    make_baseline("Lower Baseline", -half_separation, material)
