"""Generate logo 006-005 with evaluated and centered radius-one arc transforms."""
...
BLEND_PATH = ROOT / "blendfiles" / "logo-006-005.blend"
RENDER_PATH = ROOT / "renders" / "logo-006-005.png"


def load_arc_experiment():
...
def main():
    experiment = load_arc_experiment()
    original_place_characters_on_arc = experiment.place_characters_on_arc

    def place_update_and_center(characters):
    ...
    experiment.place_characters_on_arc = place_update_and_center
