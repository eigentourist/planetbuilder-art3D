"""Generate logo experiment 001-003: baseline with a horizontal finish."""
...
BLEND_PATH = ROOT / "blendfiles" / "logo-001-003.blend"
RENDER_PATH = ROOT / "renders" / "logo-001-003.png"
...
def main():
    ...
    # Preserve the rising launch profile, then ease through the final quarter
    # to an endpoint whose incoming handle is exactly horizontal.
    points = (
        ((-5.2, -1.65, 0.0), (-5.55, -2.08, 0.0), (-4.72, -0.98, 0.0)),
        ((-3.35, 0.05, 0.0), (-4.05, -0.55, 0.0), (-2.63, 0.61, 0.0)),
        ((-0.75, 1.26, 0.0), (-1.72, 1.02, 0.0), (0.18, 1.48, 0.0)),
        ((2.55, 1.64, 0.0), (1.72, 1.57, 0.0), (3.28, 1.70, 0.0)),
        ((5.2, 1.74, 0.0), (4.28, 1.74, 0.0), (5.65, 1.74, 0.0)),
    )
